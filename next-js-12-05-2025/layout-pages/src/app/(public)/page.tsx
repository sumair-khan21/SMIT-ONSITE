            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600 xl:inline">products for the future</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  We help forward-thinking companies build modern web applications that are fast, secure, and scalable. Experience the difference with our premium solutions.
                </p>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="rounded-md shadow">
                    <Link
                      href="/login"
                      className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 md:py-4 md:text-lg transition-all hover:shadow-lg"
                    >
                      Get Started
                    </Link>
                  </div>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="relative h-56 w-full sm:h-72 md:h-96 lg:h-full">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-l from-transparent to-white lg:via-white/20"></div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides everything you need to create stunning digital experiences without the hassle.
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Enterprise-grade security features built-in to protect your data and your users.
                </p>
              </div>
              ...
              <div className="relative p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Modern Architecture</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Built on the latest tech stack including Next.js, React, and Tailwind CSS.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-3 text-xl text-blue-200 sm:mt-4">
              Join thousands of others who are building the future with our tools.
            </p>
          </div>
          <dl className="mt-10 text-center sm:max-w-3xl sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8">
            <div className="flex flex-col">
              <dt className="order-2 mt-2 text-lg leading-6 font-medium text-blue-200">Active Users</dt>
            ...
            <div className="flex flex-col mt-10 sm:mt-0">
              <dt className="order-2 mt-2 text-lg leading-6 font-medium text-blue-200">Uptime</dt>
